...
if [ $flag_peakCallingbygroup -gt 0 ]; then
    ...
    read -u 9
    {
        ...
        awk '{print $1"\t"$2"\t"$3"\t"$4"\t"$7"\t"$9}' macs2_group_${group_id}_peaks.narrowPeak > macs2_group_${group_id}.bed
...
#peakCalling by individual sample
    ...
    read -u 9
    {
        ...
        awk '{print $1"\t"$2"\t"$3"\t"$4"\t"$7"\t"$9}' macs2_${sample_id}_peaks.narrowPeak > macs2_${sample_id}.bed
